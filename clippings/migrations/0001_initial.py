...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clippings_clipping', (
            ...
            ('staff', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='clippings', to=orm['staff.StaffMember'])),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('download', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True, blank=True)),
            ('news_item', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['news.NewsItem'], null=True, blank=True)),
            ('external_link', self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True)),
        ))
        db.send_create_signal('clippings', ['Clipping'])
    ...
    models = {
        ...
        'clippings.clipping': {
            'Meta': {'ordering': "['order']", 'object_name': 'Clipping'},
            'download': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['filer.File']", 'null': 'True', 'blank': 'True'}),
            'external_link': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2048', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'news_item': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['news.NewsItem']", 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'db_index': 'True'}),
            'staff': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'clippings'", 'to': "orm['staff.StaffMember']"}),
