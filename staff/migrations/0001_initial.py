...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Seniority'
        db.create_table(u'staff_seniority', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=64)),
        ))
        db.send_create_signal('staff', ['Seniority'])

        # Adding model 'StaffMember'
        db.create_table(u'staff_staffmember', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('full_name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=64)),
            ('slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=64)),
            ('seniority', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['staff.Seniority'], null=True, blank=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'Seniority'
        db.delete_table(u'staff_seniority')

        # Deleting model 'StaffMember'
        db.delete_table(u'staff_staffmember')
