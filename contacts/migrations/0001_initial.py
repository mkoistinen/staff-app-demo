...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contacts_contact', (
            ...
            ('company', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(default='', max_length=255, blank=True)),
            ('telephone', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('contact_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ...
            ('referer', self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True)),
        ))
    ...
    models = {
        ...
        u'contacts.contactcmsplugin': {
            'Meta': {'object_name': 'ContactCMSPlugin', '_ormbases': ['cms.CMSPlugin']},
